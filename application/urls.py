...
api.add_resource(invoice.InvoiceHandler, '/invoices', '/invoices/<string:invoice_id>', '/invoices/<string:invoice_id>/events', '/invoices/<string:invoice_id>/refunds', '/invoices/<string:invoice_id>/refunds/<string:request_id>', '/invoices/<string:invoice_id>/notifications')
...
api.add_resource(settlement.SettlementHandler, '/settlements', '/settlements/<string:settlement_id>', '/settlements/<string:settlement_id>/reconciliationReport')
